 ...
 *
 * @author LiaNg
 * @date 2020/5/25 23:52
 */
public class L1387 {

    public static void main(String[] args) {
        L1387 l1387 = new L1387();
//        int lo = 7, hi = 11, k = 4;
        int lo = 12, hi = 15, k = 2;
        System.out.println("l1387.getKth(lo,hi,k) = " + l1387.getKth(lo, hi, k));
    }
    ...
    public int getKth(int lo, int hi, int k) {
        ...
        PriorityQueue<Integer[]> queue = new PriorityQueue<>(k, (o1, o2) -> o1[1].equals(o2[1]) ?
                o2[0] - o1[0] : o2[1] - o1[1]);
